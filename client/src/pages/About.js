...
import { Box, Flex, Stack, Text, Grid, GridItem, Image } from '@chakra-ui/react';
				...
				<Flex direction='column' justifyContent='center' alignSelf='center' w='80vw'>
					<Stack h='88vh' mt='4vh'>
						...
						<Text
							...
							py={50}
							lineHeight={2}>
							Welcome to Yakis Sally Hair & Beauty Salon. We offer a team of skilled
							Hairdressers, Beauticians and Foot Spa Specialists, all experts in their
							field who listen to your needs and deliver excellent services you
							deserve at a reasonable price. We know how important for our customers
							to look and feel your absolute best when leaving our salon. Rest assured
							you're in great hands with the experts here at Yakis Sally Hair & Beauty
							Salon. Our exclusive hair and beauty saloon are located in Gadong,
							Bengkurong, Mentiri and Tutong. It's the ultimate one-stop salon for all
							your hair and beauty needs.
						</Text>
						<Text align='center' fontWeight='bold' fontSize='2em' pb='2vh'>
							TESTIM
							<Box as={'span'} color='brand.500'>
